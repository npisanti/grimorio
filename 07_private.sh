...
git clone https://gitlab.com/npisanti/np-sketches.git
git clone https://gitlab.com/npisanti/np-stubs.git
git clone https://gitlab.com/npisanti/scrittura.git

cd ~
git clone https://gitlab.com/npisanti/graphicsrepo.git
